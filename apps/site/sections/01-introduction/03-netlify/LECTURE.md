...
![Netlify Drop](./images/00-thumbnail.svg)
...
ただし、アカウントなしの公開は**おためし扱い**です。

- ほかの端末から開くと、パスワードを聞かれる
- 1 時間以内にアカウントに紐づけないと、公開が止まる

### アカウントがあればできること

- パスワードなしで、誰でも URL を開ける
- 期限なしで公開し続けられる
- 同じ URL のまま、中身だけ差し替えられる
- URL の前半（でたらめな名前）を好きな名前に変えられる
- いらなくなったサイトを消せる
