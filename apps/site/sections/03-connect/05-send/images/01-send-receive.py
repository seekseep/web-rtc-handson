...
sender = c.sticky(50, 84, 350, 220, color="blue")
c.text(225, 116, "押した人の画面", scale="lg", fill=PALETTE["blue"]["text"])
c.ellipse(140, 190, 38, 38, color="orange")
c.text(140, 250, "自分", scale="sm")
c.ellipse(300, 190, 38, 38, color="gray")
c.text(300, 250, "相手", scale="sm")
c.text(225, 288, "自分の丸が光る", scale="sm")
receiver = c.sticky(500, 84, 350, 220, color="green")
c.text(675, 116, "受け取った人の画面", scale="lg", fill=PALETTE["green"]["text"])
c.ellipse(590, 190, 38, 38, color="gray")
c.text(590, 250, "自分", scale="sm")
c.ellipse(750, 190, 38, 38, color="orange")
c.text(750, 250, "相手", scale="sm")
c.text(675, 288, "相手の丸が光る", scale="sm")
c.link(sender, receiver, label="{ color }", label_scale="sm", label_pos="above")
