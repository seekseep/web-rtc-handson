...
me = c.node(190, 165, "自分", emoji_cp="1f4bb")
...
c.link(me, cloud, label="new Peer()", label_scale="sm", offset=28)
c.link(cloud, me, label="名前を配る", label_scale="sm", primary=False, offset=28)
