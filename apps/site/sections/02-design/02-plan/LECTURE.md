...
見るのは 2 つです。**3 時間で作れること**と、**完成したときに見せたくなること**。
この 2 つは引っぱり合います。短時間で作れるものほど地味になりやすく、
派手なものほど時間がかかるからです。

チャットアプリは前者に寄りすぎていました。作れますが、見せたときの反応が薄い。
逆に、凝ったゲームは 3 時間では終わりません。
...
**重要な体験を先に実装します。**
色やけしごむは、あれば嬉しいけれど無くても通信は体験できます。
だから中心の体験ができたあとに回し、時間が余らなければ各自の宿題にします。

そしてこの節でやったこと自体が、今回の設計の考え方です。

1. **要件を整理する** — 満たすべきことを並べる（前の節）
2. **優先順位を決める** — 中心に置くものを 1 つ選ぶ（前の節）
