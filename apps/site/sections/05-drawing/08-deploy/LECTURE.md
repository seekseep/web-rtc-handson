...
今回のお絵かきアプリは、描いた絵を「保存」しません。
ブラウザ同士を直接つなぐやり方には、「記録係」がいないからです
（くわしくは [04 章 01 節](../../04-how-it-works/01-compare/LECTURE.md)）。
...
[05 章 03 節](../03-share/LECTURE.md) で見たとおり、
...
[03 章 06 節](../../03-connect/06-deploy/LECTURE.md) と同じ手順です。
...
もっと遊びたい人のために、**06 章を付録**として用意しました。
こちらは組み立てる形ではなく、**答えが最初から書いてあります**。
3 つとも独立しているので、好きなものだけ拾ってください。

- [01 相手のカーソルを表示する](../../06-extra/01-cursor/LECTURE.md) — この節の完成コードに 1 つだけ足したもの
- [02 色塗りバトル](../../06-extra/02-battle/LECTURE.md) — 同じ仕組みで作った対戦ゲーム。遊んでから中身を読む
- [03 NAT とは何か](../../06-extra/03-nat/LECTURE.md) — 家からインターネットまでに何が起きているか
